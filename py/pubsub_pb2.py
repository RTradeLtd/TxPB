...
_PUBLISHREQUEST = _descriptor.Descriptor(
  name='PublishRequest',
  full_name='pb.PublishRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='topic', full_name='pb.PublishRequest.topic', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='pb.PublishRequest.data', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='advertise', full_name='pb.PublishRequest.advertise', index=2,
...
_SUBSCRIBEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='topic', full_name='pb.SubscribeRequest.topic', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='discover', full_name='pb.SubscribeRequest.discover', index=1,
...
PublishRequest = _reflection.GeneratedProtocolMessageType('PublishRequest', (_message.Message,), {
  ...
  '__module__' : 'pubsub_pb2'
  # @@protoc_insertion_point(class_scope:pb.PublishRequest)
  })
