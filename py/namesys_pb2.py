...
_NAMESYSAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='NameSysNameSysResolve',
    full_name='pb.NameSysAPI.NameSysNameSysResolve',
    index=0,
