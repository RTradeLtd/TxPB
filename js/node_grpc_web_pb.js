 ...
 */
const methodInfo_NodeAPI_Blockstore = new grpc.web.AbstractClientBase.MethodInfo(
  proto.pb.BlockstoreResponse,
 ...
 *     The XHR Node Readable Stream
 */
proto.pb.NodeAPIClient.prototype.blockstore =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/pb.NodeAPI/Blockstore',
      request,
      metadata || {},
      methodInfo_NodeAPI_Blockstore,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.pb.NodeAPIPromiseClient.prototype.blockstore =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/pb.NodeAPI/Blockstore',
      request,
