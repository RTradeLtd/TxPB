...
proto.pb.P2PRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    allowcustomprotocols: jspb.Message.getFieldWithDefault(msg, 8, false),
    reportpeerid: jspb.Message.getFieldWithDefault(msg, 9, false)
  };
...
proto.pb.ConnMgmtRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    requesttype: jspb.Message.getFieldWithDefault(msg, 1, 0),
    multiaddrsList: jspb.Message.getRepeatedField(msg, 2),
    peeridsList: jspb.Message.getRepeatedField(msg, 3)
  };
...
proto.pb.ConnMgmtResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    peeridsList: jspb.Message.getRepeatedField(msg, 4)
  };
...
proto.pb.ConnMgmtResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pb.ConnMgmtStatus.deserializeBinaryFromReader, "");
         });
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
...
proto.pb.BlockstoreRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    requesttype: jspb.Message.getFieldWithDefault(msg, 1, 0),
    reqoptsList: jspb.Message.getRepeatedField(msg, 2),
...
proto.pb.KeystoreResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    requesttype: jspb.Message.getFieldWithDefault(msg, 1, 0),
    privatekey: msg.getPrivatekey_asB64(),
    keynamesList: jspb.Message.getRepeatedField(msg, 3),
    has: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
