...
goog.exportSymbol('proto.pb.ConnMgmtResponse.StatusMessage', null, global);
 ...
 * @constructor
 */
proto.pb.ConnMgmtResponse.StatusMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ConnMgmtResponse.StatusMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ConnMgmtResponse.StatusMessage.displayName = 'proto.pb.ConnMgmtResponse.StatusMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pb.ConnMgmtResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    statusMap: (f = msg.getStatusMap()) ? f.toObject(includeInstance, proto.pb.ConnMgmtResponse.StatusMessage.toObject) : [],
...
proto.pb.ConnMgmtResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pb.ConnMgmtResponse.StatusMessage.deserializeBinaryFromReader, "", new proto.pb.ConnMgmtResponse.StatusMessage());
         });
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
...
proto.pb.ConnMgmtResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.pb.ConnMgmtResponse.StatusMessage.serializeBinaryToWriter);
  }
  f = message.getPeeridsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Object}
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ConnMgmtResponse.StatusMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ConnMgmtResponse.StatusMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ConnMgmtResponse.StatusMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ConnMgmtResponse.StatusMessage}
 */
proto.pb.ConnMgmtResponse.StatusMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ConnMgmtResponse.StatusMessage;
  return proto.pb.ConnMgmtResponse.StatusMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ConnMgmtResponse.StatusMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ConnMgmtResponse.StatusMessage}
 */
proto.pb.ConnMgmtResponse.StatusMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ConnMgmtResponse.StatusMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ConnMgmtResponse.StatusMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ConnMgmtResponse.StatusMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.getDisconnected = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.pb.ConnMgmtResponse.StatusMessage} returns this
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.setDisconnected = function(value) {
 ...
 * @return {string}
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.getReason = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pb.ConnMgmtResponse.StatusMessage} returns this
 */
proto.pb.ConnMgmtResponse.StatusMessage.prototype.setReason = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.pb.ConnMgmtResponse.StatusMessage>}
 */
proto.pb.ConnMgmtResponse.prototype.getStatusMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.pb.ConnMgmtResponse.StatusMessage>} */ (
      jspb.Message.getMapField(this, 3, opt_noLazyCreate,
      proto.pb.ConnMgmtResponse.StatusMessage));
};
